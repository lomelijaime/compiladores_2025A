...
#line 48 "parser.y"
    {
                agregar((yyvsp[(2) - (3)].str));         // Registra una declaración
            ;}
    break;
...
#line 51 "parser.y"
    {
                agregar((yyvsp[(3) - (4)].str));         // Registra declaraciones adicionales
            ;}
    break;

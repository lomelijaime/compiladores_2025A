...
static const char *const yytname[] =
{
  ...
  "$accept", "programa", "declaraciones", "asignaciones", 0
};
#endif
...
#line 56 "parser.y"
    {
        ...
        else if (buscar_tipo((yyvsp[(1) - (4)].str)) != buscar_tipo((yyvsp[(3) - (4)].str)))           // Verifica que sean del mismo tipo
